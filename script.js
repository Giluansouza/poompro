...
localStorage.setItem('acao', String(25))
localStorage.setItem('pausa', String(5))
localStorage.setItem('sessoes', String(1))

document.getElementById('minutes_ok').innerHTML = "25"
document.getElementById('seconds_ok').innerHTML = "00"
